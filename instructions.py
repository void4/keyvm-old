...
HEADER, KEYS, CODE, DATA, STACK = range(5)
...
NUMINSTR = 23
I_HALT, I_RETURN, I_CREATE, I_ALLOC, I_TRANSFERKEY, I_RECURSE, I_MEMSIZE, I_MEMWRITE, I_MEMCREATE, I_ADD, I_SUB, I_MUL, I_DIV, I_JUMP, I_JUMPIF, I_CODEREAD, I_CODELEN, I_PUSH, I_DUP, I_MEMPUSH, I_FORK, I_RANDOM, I_NUMKEYS = range(NUMINSTR)
INAMES = "I_HALT, I_RETURN, I_CREATE, I_ALLOC, I_TRANSFERKEY, I_RECURSE, I_MEMSIZE, I_MEMWRITE, I_MEMCREATE, I_ADD, I_SUB, I_MUL, I_DIV, I_JUMP, I_JUMPIF, I_CODEREAD, I_CODELEN, I_PUSH, I_DUP, I_MEMPUSH, I_FORK, I_RANDOM, I_NUMKEYS".split(", ")
